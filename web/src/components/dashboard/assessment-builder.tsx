  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Section title="Basics" desc="Name the assessment and pick its course.">
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input placeholder="e.g. Midterm: Thermodynamics" className={fieldCls} />
          </div>
          <div>
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        ...
        <button className="active-glow flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-[#16181a] transition hover:opacity-90 active:scale-[0.98]">
      ...
      <p className="font-label-cosmic text-[10px] uppercase tracking-wider text-[#c4c7c8]/40">
        Generation runs once the Phase 2/3 backend is connected
      </p>
    </div>
  );
}
